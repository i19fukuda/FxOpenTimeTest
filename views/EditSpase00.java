...
public class EditSpase00 {
    final private int LINE_WIDE_SIZE = 48;
    final private int MAX_NOTE_SIZE = 127;
    final private int TEMPO = 120;
    //テスト用に改変
    //マックスのサイズによってどれぐらいの性能差が出るか検証
    private int maxRootWidth = 12000;
    private int maxRootHeight = 400000;
    ...
    public EditSpase00 (MidiConductor midiConductor){
